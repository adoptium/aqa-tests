...
export CRIU_COMBO_LIST_aarch64_linux=sw.os.ubuntu.20-hw.arch.aarch64.armv8 sw.os.ubuntu.22-hw.arch.aarch64.armv8 sw.os.rhel.9-hw.arch.aarch64.armv8
# not available: sw.os.rhel.8-hw.arch.aarch64.armv8
