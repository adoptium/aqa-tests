# External openliberty-mp-tck Tests
Openliberty-mp-tck tests are part of the third-party application tests help verify that the Adoptium binaries are good by running a variety of Java applications inside of Docker containers. Adoptium/aqa-tests/Issue [#172](https://github.com/adoptium/aqa-tests/issues/172) lists the applications that we have initially targeted to best exercise the Adoptium binaries. For each application, we choose to run a selection of their functional tests. Openliberty-mp-tck tests are functional tests pulled from the [open-liberty](https://github.com/OpenLiberty/open-liberty.git) repository.

## Running External openliberty-mp-tck tests locally
