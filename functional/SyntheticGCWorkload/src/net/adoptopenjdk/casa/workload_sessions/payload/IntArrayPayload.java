...
public class IntArrayPayload extends ArrayPayload 
{
	protected static final int BYTES_PER_ELEMENT = 4;  
	
	int[] payload; 
	
	public IntArrayPayload(PayloadConfiguration configuration) throws PayloadException
	{
		super(configuration);

		payload = new int[(int)getNumElements(BYTES_PER_ELEMENT)]; 
	}	
}