...
java %JAVA_OPTIONS% RegexReplaceTest ª¢ß­ô×»õÓú aiueo %PWD%\win_ko.txt -v
@echo --- Confirm that "ª¢ß­ô×»õÓú" was replaced by "aiueo". 
@echo --- OK ?

java %JAVA_OPTIONS% RegexReplaceTest ´·é¡ Üþ°ÖÜþ¸Ø %PWD%\win_ko.txt -v
@echo --- Confirm that "´·é¡" was replaced by "Üþ°ÖÜþ¸Ø". 
@echo --- OK ?

java %JAVA_OPTIONS% RegexReplaceTest ¡Í \\ %PWD%\win_ko.txt -v
@echo --- Confirm that "¡Í" was replaced by "\". 
@echo --- OK ?

java %JAVA_OPTIONS% RegexReplaceTest "íÏ.*Âú" "£µ£ã»Ï½Àéè" %PWD%\win_ko.txt -v
@echo --- Confirm that "íÏ.*Âú" was replaced by "£µ£ã»Ï½Àéè". 
@echo --- OK ?

java %JAVA_OPTIONS% RegexReplaceTest ª¢ª«ªµ Âúï» %PWD%\win_ko.txt -v
@echo --- Confirm that "ª¢ª«ªµ" was replaced by "Âúï»". 
@echo --- OK ?

java %JAVA_OPTIONS% RegexReplaceTest [¢à¢å¨õ¥´] èâ½À %PWD%\win_ko.txt -v
