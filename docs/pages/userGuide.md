...
Use test paths (or comma-separated test paths) for `<testcases>`. For valid `<platform>` values, refer to: https://github.com/adoptium/aqa-tests/blob/master/openjdk/README.md#exclude-a-testcase
