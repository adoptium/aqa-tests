...
``` bash
make ExtendedTestExample_SE80_0
```
...
2) One-time append: If you want to append options to the set that are already there, use `EXTRA_OPTIONS="your extra options"`.  For example, `make ExtendedTestExample_SE80_0 EXTRA_OPTIONS=-Xint` will append to those options already in the make target.
