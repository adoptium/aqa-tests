...
EXEC_RUNTIME_TEST_JDWP = $(TEST_ROOT)/jck/jck-jdwp-test-drive.sh '$(START_AGENT_GENERIC)' '$(EXEC_RUNTIME_TEST_NO_JTB)' @$(REPORTDIR)/generated.jtb $(TEST_STATUS) $(GEN_SUMMARY_GENERIC) $(JCK_ROOT) $(JCK_VERSION_NUMBER) $(TEST_JDK_HOME)
