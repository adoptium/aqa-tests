...
node {
  ...
  {
    sh "ls -1dq ${WORKSPACE}/aqa-tests/openjdk/excludes/* | python3 ${WORKSPACE}/aqa-tests/scripts/disabled_tests/exclude_parser.py > ${WORKSPACE}/aqa-tests/scripts/disabled_tests/problem_list.json"
